...
| 路径 | 用途 |
|:---|:---|
| `index.html` | 主落地页（自包含 CSS/JS，15 区块） |
...
1. **页面主角永远是 WorkbuddyLink**，NexFDE 作为总品牌出现在页脚品牌体系区
2. **主 CTA**: 预约沟通 | **次 CTA**: 申请渠道合作
...
当前: `连接企业增长机会与交付能力的合作入口 | WorkbuddyLink` ✅

### B. 页面描述
描述是 AI 生成答案时的摘要来源，必须包含：做什么 + 为谁做 + 独特价值。
当前: `WorkbuddyLink 以前端生态入口连接企业客户与渠道伙伴，以 FDE 定制化交付网络承接培训、销售转化、方案落地与持续运营需求，打造可合作、可交付、可复制的增长模式。` ✅
...
3. 列表和表格优于大段文字
4. 关键术语首次出现时加 `<strong>` 标记（Workbuddy、FDE、渠道伙伴、交付网络、方法论复制、规模化增长）
